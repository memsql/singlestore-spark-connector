...
## Version: 3.0.3 [![Continuous Integration](https://circleci.com/gh/memsql/memsql-spark-connector/tree/master.svg?style=shield)](https://circleci.com/gh/memsql/memsql-spark-connector) [![License](http://img.shields.io/:license-Apache%202-brightgreen.svg)](http://www.apache.org/licenses/LICENSE-2.0.txt)
...
```
$SPARK_HOME/bin/spark-shell --packages com.memsql:memsql-spark-connector_2.11:3.0.3-spark-2.4.4
```

We release two versions of the `memsql-spark-connector`, one per Spark version.
An example version number is: `3.0.3-spark-2.3.4` which is the 3.0.3
...
The MemSQL Spark Connector 3.0.3 has a number of key features and enhancements:
