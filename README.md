...
```
$SPARK_HOME/bin/spark-shell --packages com.singlestore:singlestore-spark-connector_2.12:4.1.4-spark-3.5.0
```
...
For example, in connector `4.1.4-spark-3.5.0`, 4.1.4 is the version of the connector, 
