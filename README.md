...
## Version: 4.1.9 [![License](http://img.shields.io/:license-Apache%202-brightgreen.svg)](http://www.apache.org/licenses/LICENSE-2.0.txt)
...
For example, in connector `4.1.9-spark-3.5.0`, 4.1.9 is the version of the connector, 
