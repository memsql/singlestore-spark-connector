...
```
$SPARK_HOME/bin/spark-shell --packages com.singlestore:singlestore-spark-connector_2.12:4.1.10-spark-4.0.0
```
...
For example, in connector `4.1.10-spark-4.0.0`, 4.1.10 is the version of the connector, 
