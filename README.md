...
## Version: 4.0.1-beta [![License](http://img.shields.io/:license-Apache%202-brightgreen.svg)](http://www.apache.org/licenses/LICENSE-2.0.txt)
...
```
$SPARK_HOME/bin/spark-shell --packages com.singlestore:singlestore-spark-connector_2.12:4.0.1-beta-spark-3.1.0
```

We release two versions of the `singlestore-spark-connector`, one per Spark version.
An example version number is: `.4.0.1-beta-spark-3.1.0` which is the 4.0.1-beta
...
The SingleStore Spark Connector 4.0.1-beta has a number of key features and enhancements:
