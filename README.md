...
## Version: 4.0.0 [![License](http://img.shields.io/:license-Apache%202-brightgreen.svg)](http://www.apache.org/licenses/LICENSE-2.0.txt)
...
An example version number is: `.4.0.0-spark-3.1.0` which is the 4.0.0
...
| `createRowstoreTable`                             | If set and during the writing table is created - rowstore table will be created (default: `false`)
...
> you will need to set `createRowstoreTable` option.
