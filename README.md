...
| `tableExists`                                      | -                                                     | Specifies whether the target table already exists. When set to `true`, the connector assumes the table exists and skips the database existence check. When set to `false`, the connector assumes the table does not exist and creates it. When unset, the connector queries the database to determine whether the table exists.
