...
## Version: 4.1.8-beta [![License](http://img.shields.io/:license-Apache%202-brightgreen.svg)](http://www.apache.org/licenses/LICENSE-2.0.txt)
...
```
$SPARK_HOME/bin/spark-shell --packages com.singlestore:singlestore-spark-connector_2.12:4.1.8-beta-spark-3.5.0
```
...
For example, in connector `4.1.8-beta-spark-3.5.0`, 4.1.8-beta is the version of the connector, 
