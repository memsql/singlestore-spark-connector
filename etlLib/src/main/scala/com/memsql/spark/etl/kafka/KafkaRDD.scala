...
class KafkaRDD[
  ...
  //NOTE: Reimplemented NextIterator[R] because it is private to org.apache.spark.util
  private class KafkaRDDIterator(
      part: KafkaRDDPartition,
      context: TaskContext) extends Iterator[R] {
    private var gotNext = false
    private var nextValue: R = _
    ...
    protected def close(): Unit = consumer.close()

    protected def getNext(): R = {
