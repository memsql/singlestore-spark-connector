...
RUN sudo wget -q -O /storage/testroot/memsql-spark/memsql-spark.tar.gz \
    http://download.memsql.com/memsql-spark-1.4.1-distribution-0.2.2/memsql-spark-1.4.1-distribution-0.2.2.tar.gz && \
...
ADD tests/target/scala-2.10/tests-assembly-0.2.2.jar /storage/testroot/memsql-spark/interface/memsql_spark_interface.jar
