...
RUN sudo wget -q -O /storage/testroot/memsql-spark/memsql-spark.tar.gz \
    http://download.memsql.com/memsql-spark-1.4.1-distribution-0.1.6/memsql-spark-1.4.1-distribution-0.1.6.tar.gz && \
...
ADD tests/target/scala-2.10/tests-assembly-0.1.6.jar /storage/testroot/memsql-spark/interface/interface.jar
