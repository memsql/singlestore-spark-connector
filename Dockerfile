...
RUN sudo wget -q -O /storage/testroot/memsql-spark/memsql-spark.tar.gz \
    http://download.memsql.com/memsql-spark-1.5.0-distribution-0.1.9/memsql-spark-1.5.0-distribution-0.1.9.tar.gz && \
...
ADD tests/target/scala-2.10/tests-assembly-0.1.9.jar /storage/testroot/memsql-spark/interface/memsql_spark_interface.jar
