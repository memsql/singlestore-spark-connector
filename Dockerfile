...
RUN sudo wget -q -O /storage/testroot/memsql-spark/memsql-spark.tar.gz \
    http://download.memsql.com/memsql-spark-1.5.2-distribution-1.3.2-SNAPSHOT/memsql-spark-1.5.2-distribution-1.3.2-SNAPSHOT.tar.gz && \
...
ADD tests/target/scala-2.10/tests-assembly-1.3.2-SNAPSHOT.jar /storage/testroot/memsql-spark/interface/memsql_spark_interface.jar
