...
public interface PythonTransformerInterface extends Serializable {
     ...
     * @param config The Transformer configuration string passed from MemSQL Ops.
     * @param logger A logger instance that is integrated with MemSQL Ops.
     */
    void Py4JInitialize(SQLContext sqlContext, String config, PhaseLogger logger);
     ...
     * @param logger A logger instance that is integrated with MemSQL Ops.
     */
    void Py4JCleanup(SQLContext sqlContext, String config, PhaseLogger logger);
     ...
     */
    DataFrame Py4JTransform(SQLContext sqlContext, DataFrame df, String config, PhaseLogger logger);
}
